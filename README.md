...
To get this image, pull it from [docker hub](https://registry.hub.docker.com/u/wachira90/rsyslog-elasticsearch-kibana/):

```
$ docker pull wachira90/rsyslog-elasticsearch-kibana:v1
```

Or, if you want to build this image yourself, clone the [github repo](https://github.com/wachira90/rsyslog-elasticsearch-kibana) and in directory with Dockerfile run:
...
```
$ docker run -d -p 514:514 -p 514:514/udp -p 5601:5601 -v /etc/localtime:/etc/localtime:ro wachira90/rsyslog-elasticsearch-kibana:v1
```
